        ...
        <div class="row">
            ...
            <div class="col-10">
                ...
                <div class="col-12 ms-3">
                    <table class="tg table table-striped" style="width: 100%">
                        <colgroup>
                            <col style="width: 10%">
                            <col style="width: 18%">
                            <col style="width: 10%">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="block">닉네임</th>
                                <th class="block">나이</th>
                                <th class="block">성별</th>
                                <th class="block">차단날짜</th>
                                <th class="block">차단사유</th>
                                <th class="block">추방해제</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td class="block1">${status.count }</td>
                                <td class="block3">${bm.uNick }</td>
                                <td class="block1">${bm.uAge }</td>
                                <td class="block3">${bm.uGender }</td>
                                <td class="block1"> <fmt:formatDate value="${bm.bDate }" pattern="yyyy-MM-dd"/></td>
                                <td class="block3">${bm.bmCont }</td>
                                <td class="blcok1"> <button type="button" style="font-size: 100%; font-weight:200;" class="btn btn-primary btn-sm ms-3" onclick="location.href='${path}/moim/cancelBan?uNo=${bm.uNo }'">추방해제</button></td>
                            </tr>
                            
                            </c:forEach>
                            </c:if>
                            <c:if test="${empty bmList }">
                            	<tr><td colspan="7" style="width:100%;text-align:center;font-size:20px;">조회된 유저가 없습니다.</td></tr>
                            </c:if>
                        </tbody>
                    </table>
