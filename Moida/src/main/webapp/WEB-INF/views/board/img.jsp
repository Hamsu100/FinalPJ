            ...
            <div class="flex-shrink-0 bg-white sidebar" style="width: 200px;">
                ...
                <div class="text-center mt-2">
                    ...
                    <div class="mt-2 mb-2">
                        ...
                        <button type="button" data-bs-toggle="button" autocomplete="off" id="attentionbtn" onclick='addattention()' class="ms-1 btn btn-outline-primary btn-xs">관심추가</button>
                    </div>
                    <h4 id="gName">
                    </h4>
            ...
            <div class="col-10">
                ...
                <div class="mt-4 ms-3">
                    ...
                    <c:if test="${empty bList }">
                    	<div style="width:100%;text-align:center;margin-top:50px;"><p>조회된 게시물이 없습니다.</p></div>
                    </c:if>
                    <c:if test="${!empty bList }">
                    	<c:forEach var="b" items="${bList }" varStatus="status">
                                ...
                                <th class="photo1">
                            	<a href="${path }/board/detail?bNo=${b.bNo}">
                                    <div class="card mb-2 ">
                                        <div class="photo-board">
                                            <img src="${path }/resources/upload/board/${b.bRen}" style="width:250px;">
                                        </div>
                                        <div>
                                            <h3 class="ms-3 mt-2"> ${b.bTitle } </h3>
                                            <table>
                                                <th>
                                                    <span>
                                                        <i class="fa-solid fa-user icon-coral ms-3 "> </i> <span class="m-1">${b.uNick }</span>
                                                    </span>
                                                </th>
                                                <th>
                                                    <i class="fa-regular fa-eye icon-coral "> </i> <span class="m-1">${b.bRdCnt }</span>
                                                </th>
                                                <th>
                                                    <i class="fa-regular fa-calendar-days icon-coral  "> </i> <span class="m-1"><fmt:formatDate value="${b.bMdf}" pattern="yyyy-MM-dd"/></span>
                                                </th>
                                            </table>
                                        </div>
                                    </div>
                ...
                <div aria-label=" navigation example " class="my-5 ">
